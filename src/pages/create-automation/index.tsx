...
export default function CreateAutomationPage() {
    ...
    return (
        <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {automationTypes.map((type) => (
                        <Card
                            ...
                            className={`cursor-pointer border-2 ${selectedType === type.label
                                    ? "border-blue-600"
                                    : "border-transparent"
                                }`}
                        >
            ...
            {/* 4. Special Case: Create Automation with AI */}
            <div className="mt-6">
                <h2 className="font-semibold mb-2">Special Case: Create with AI</h2>

                {/* AI Prompt Input */}
                <Input
                    placeholder="What would you like to message your customers about?"
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                />
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        // Replace with your API or AI integration
                        setDraftMessage(
                            `Hi {{ customer.first_name }}, just a reminder from {{ shop.name }}: ${description}. Visit us at {{ shop.website_url }}.`
                        );
                    }}
                >
                    Regenerate Message
